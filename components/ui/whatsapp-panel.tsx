...
const conversasFake = {
  c1: [
    ...
    {
      remetente: "vendedor",
      texto: "Está por R$ 150, com 10% de desconto à vista.",
    },
  ],
  c2: [
  ...
  c3: [
    ...
    {
      remetente: "vendedor",
      texto: "Olá! Ainda temos unidades. Posso garantir a promoção pra você.",
    },
  ],
};
    ...
    <div className="w-full h-[500px] border rounded-lg shadow-md mt-6 bg-white flex">
      ...
      <div className="w-3/4 flex flex-col justify-between p-4">
        ...
        <div className="flex-1 overflow-y-auto space-y-3 bg-gray-50 p-4 rounded">
          {conversasFake[contatoSelecionado as keyof typeof conversasFake]?.map(
            (mensagem, idx) => (
              <div
                key={idx}
